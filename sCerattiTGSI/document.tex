...
\input{secoes-artigo/identificacoa.tex} 
%%%------------------SBC-ARTIGO--------------------------
...
%\input{secoes-proposta/referencialTeorico.tex}
...
%%%-----------------------------------%% BEGIN ARTIGO
  ...
  \input{secoes-artigo/introducao.tex}
   \input{secoes-artigo/trabalhosRelacionados}
  \input{secoes-artigo/gDeTI}
  \input{secoes-artigo/gTInaUFSM}
  %\input{secoes-artigo/analise} 
  %\input{secoes-artigo/roteiroDeImplantacao}
  \input{secoes-artigo/propostGTI}
  %\input{secoes-artigo/citsmart}
